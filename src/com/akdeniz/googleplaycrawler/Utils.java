...
import com.akdeniz.googleplaycrawler.GoogleServicesFramework.AndroidBuildProto;
import com.akdeniz.googleplaycrawler.GoogleServicesFramework.AndroidCheckinProto;
import com.akdeniz.googleplaycrawler.GoogleServicesFramework.AndroidCheckinRequest;
import com.akdeniz.googleplaycrawler.GoogleServicesFramework.DeviceConfigurationProto;
...
public class Utils {
	 ...
	 * 
	 * <a href="http://www.glbenchmark.com/phonedetails.jsp?benchmark=glpro25&D=Samsung+GT-I9300+Galaxy+S+III&testgroup=system">
	...
	// TODO : Whole duplicate of above code. Need to merge classes in GoogleServicesFramework and Googleplay!
	public static com.akdeniz.googleplaycrawler.Googleplay.DeviceConfigurationProto getDeviceConfigurationProto() {
		return com.akdeniz.googleplaycrawler.Googleplay.DeviceConfigurationProto
		.newBuilder()
		.setTouchScreen(3)
		.setKeyboard(1)
		.setNavigation(1)
		...
		.addAllGlExtension(
			Arrays.asList("GL_EXT_debug_marker", "GL_EXT_discard_framebuffer",
				...
				"GL_OES_texture_env_crossbar", "GL_OES_texture_float",
				"GL_OES_texture_half_float", "GL_OES_texture_mirrored_repeat",
				"GL_OES_vertex_array_object", "GL_OES_vertex_half_float")).build();
	    }
}
